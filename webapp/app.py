...
import graph     # Main tab, with controls and graph of deltaT
import programme # Tab for specifying the DTA programme
import settings  # Tab for configuring PID parameters and time interval
import export    # Tab for saving and exporting data to attached filestorage
#import imaging  # Displays view from thermal imaging camera
import shared
from shared import appState        # Not a page - this module holds the global variables 
